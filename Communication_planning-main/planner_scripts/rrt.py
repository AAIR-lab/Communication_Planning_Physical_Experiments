...
class RRT:
    ...
    def planning(self):
        ...
        #self.counter = 1
        self.calc_node_cost(node = init_node, goal_node = goal_node, final_goal_node = final_goal_node) # associate cost to the init_node
        ...
        for i in range(self._max_iter):
            ...
            new_node = self.steer(node_sample, control_ref)                 # steering function
            self.calc_node_cost(node = new_node, goal_node = goal_node, final_goal_node = final_goal_node) # assign cost to the new node
    ...
    def steer(self, from_node, control_ref):
        time = from_node.t
    ...
    def calc_node_cost(self, node, goal_node, final_goal_node):
        ...
        node.cost = self._cost_weights[0]*cost_to_goal + self._cost_weights[2]*heading_cost + self._cost_weights[3]*trap_cost
